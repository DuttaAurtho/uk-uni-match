  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative bg-surface border border-border rounded-xl shadow-lg w-full max-w-2xl max-h-[85vh] overflow-y-auto animate-pop-in"
      >
          ...
          {status === "success" && details && (
            <div className="space-y-5">
              {details.source && details.source !== "gemini" && (
                <p className="text-xs font-medium text-gold-dark bg-gold/10 inline-block px-2.5 py-1 rounded-full">
              ...
              {SECTIONS.map(([key, label]) =>
                details[key] ? (
                  <div key={key}>
                    <h3 className="text-xs font-semibold uppercase tracking-wide text-gold-dark mb-1">
                      {label}
                    </h3>
              ...
              <div className="flex flex-wrap gap-3 pt-2 border-t border-border">
                {details.official_url && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 bg-gold hover:bg-gold-light transition-colors text-navy font-semibold px-4 py-2 rounded-md text-sm"
                  >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 border border-border hover:bg-background transition-colors text-text-primary px-4 py-2 rounded-md text-sm"
                >
